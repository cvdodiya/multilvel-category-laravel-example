            ...
            <div class="box box-primary">
                ...
                <form role="form" method="post">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="category_title" class="form-control" placeholder="Category name" value="{{old('category_title')}}" required />
                                </div>
                            </div>
                    ...
                    <div class="box-footer">
                        ...
                        <a href="{{ url('categories') }}" class="btn btn-primary">List All Categories</a>
                    </div>
                </form>
